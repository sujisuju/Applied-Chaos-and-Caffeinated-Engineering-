    ...
    if len(scan_x) > 0:
        ...
        def generate_quick_ftir_pdf(data_lines):
            ...
            for title, points, _ in data_lines:
                ...
                pdf.set_font("Helvetica", "", 10)
                # FIXED: Force explicit width parameter to allow structural multi_cell auto-wrapping
        ...
        def generate_detailed_ftir_pdf(data_lines):
            ...
            pdf.multi_cell(190, 6, "This comprehensive document logs the computational extraction of continuous infrared absorbency waves. The sub-pixel tracking filters isolated baseline variations to translate quantum particle oscillations directly into formal analytical diagnostic bands.", new_x="LMARGIN", new_y="NEXT")
            pdf.ln(5)
            ...
            for title, points, description in data_lines:
                ...
                # FIXED: Force explicit spacing boundaries to clear out horizontal margin errors
